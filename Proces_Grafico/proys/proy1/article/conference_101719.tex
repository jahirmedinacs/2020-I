...
\author{\IEEEauthorblockN{1\textsuperscript{st} Medina Lopez Jahir Gilberth}
\IEEEauthorblockA{\textit{Escuela de Informatica} \\
	\textit{Universidad Nacional de Trujillo}\\
	Trujillo, Peru \\
	1012700115}
\and
\IEEEauthorblockN{2\textsuperscript{st} Pastor Salazar Christian Martín}
\IEEEauthorblockA{\textit{Escuela de Informatica} \\
	\textit{Universidad Nacional de Trujillo}\\
	Trujillo, Peru \\
	1052701715}
\and
\IEEEauthorblockN{3\textsuperscript{st} Salinas Grados Jhosep Emerson}
\IEEEauthorblockA{\textit{Escuela de Informatica} \\
	\textit{Universidad Nacional de Trujillo}\\
	Trujillo, Peru \\
	1012700815}
\and
\IEEEauthorblockN{4\textsuperscript{st} Sifuentes Ñiquin Víctor Hugo}
\IEEEauthorblockA{\textit{Escuela de Informatica} \\
	\textit{Universidad Nacional de Trujillo}\\
	Trujillo, Peru \\
	1022700315}
